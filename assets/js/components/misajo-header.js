class MisajoHeader extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const isSubPage = path.includes('/productos/') || path.includes('/blog/') || path.includes('/combos/') || path.includes('/tarjetas/') || path.includes('/pedidos/');
            ...
            <header id="header">
                <nav>
                    ...
                    <ul class="nav-links desktop-nav">
                        ...
                        <li><a href="${rootPath}pedidos/">Haz Tu Pedido</a></li>
            ...
            <div class="mobile-menu-overlay">
                <div class="mobile-menu-container">
                    <ul class="mobile-nav-links">
                        ...
                        <li style="--i:3"><a href="${rootPath}pedidos/">Haz Tu Pedido</a></li>
                        <li style="--i:4"><a href="${nosotrosHref}">Nosotros</a></li>
                        <li style="--i:5"><a href="${contactoHref}">Contacto</a></li>
                    </ul>
                    <div class="mobile-socials" style="--i:6">
